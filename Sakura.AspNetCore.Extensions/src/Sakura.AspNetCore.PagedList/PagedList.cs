...
namespace Sakura.AspNetCore
{
	...
	public class PagedList<TSource, TElement> : IPagedList<TElement>
	{
		...
		/// The <paramref name="pageSize"/> or <paramref name="pageIndex"/> is not positive, or the <paramref name="totalCount"/> or <paramref name="totalPage"/> is negative.
		/// </exception>
		...
		/// <summary>
		/// The source of the page data. This property is a reference of the constructor argument, any change of the source will not be watched.
		/// </summary>
		[PublicAPI]
