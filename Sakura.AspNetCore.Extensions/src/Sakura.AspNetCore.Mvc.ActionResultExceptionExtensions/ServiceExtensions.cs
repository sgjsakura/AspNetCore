...
{
	/// <summary>
	/// Provide extension methods for register <see cref="EnableActionResultExceptionAttribute"/> globally. This class is static.
	/// </summary>
	public static class ServiceExtensions
	{
		/// <summary>
		/// Add <see cref="EnableActionResultExceptionAttribute"/> as a exception filter in the <paramref name="filterCollection"/>.
		/// </summary>
