...
namespace Sakura.AspNetCore.Authentication
{
	...
	public class ExternalSignInManager
	{
		...
		/// </summary>
		/// <returns>If signing-in is succeeded, returns the generated <see cref="ClaimsPrincipal" /> object for current user; otherwise, returns <c>null</c>.</returns>
		[PublicAPI]
		...
		/// <returns>The user name included in the <paramref name="identity" />. If no user name is included, this method will return <c>null</c>.</returns>
		[CanBeNull]
		[PublicAPI]
		...
		/// <returns>The user name included in the <paramref name="principal" />. If no user name is included, this method will return <c>null</c>.</returns>
		[CanBeNull]
		[PublicAPI]
		...
		/// <param name="identity">The <see cref="ClaimsIdentity"/> instance.</param>
		/// <exception cref="ArgumentNullException">The <paramref name="identity" /> is <c>null</c>.</exception>
		/// <returns>The user identifier included in the <paramref name="identity" />. If no user identifier is included, this method will return <c>null</c>.</returns>
		[CanBeNull]
		[PublicAPI]
		...
		/// <param name="principal">The <see cref="ClaimsPrincipal"/> instance.</param>
		/// <exception cref="ArgumentNullException">The <paramref name="principal" /> is <c>null</c>.</exception>
		/// <returns>The user identifier included in the <paramref name="principal" />. If no user identifier is included, this method will return <c>null</c>.</returns>
		[CanBeNull]
		[PublicAPI]
		...
		/// <param name="identity">The <see cref="ClaimsIdentity"/> instance.</param>
		/// <exception cref="ArgumentNullException">The <paramref name="identity" /> is <c>null</c>.</exception>
		/// <returns>A collection that including all the roles for the <paramref name="identity" />. If the user has no roles, this method will return a empty collection.</returns>
		[NotNull]
		[PublicAPI]
		...
		/// <exception cref="ArgumentNullException">The <paramref name="principal" /> is <c>null</c>.</exception>
		/// <returns>If the current user is signed-in with application's primary authentication scheme, returns <c>true</c>; otherwise, returns <c>false</c>.</returns>
		[PublicAPI]
