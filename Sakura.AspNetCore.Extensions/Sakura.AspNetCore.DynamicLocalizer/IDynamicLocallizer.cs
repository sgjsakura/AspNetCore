...
namespace Sakura.AspNetCore.Localization
{
	...
	/// </summary>
	public interface IDynamicLocallizer
	{
		/// <summary>
		/// Get a dynamic object that can be used to access localizble strings similar as <see cref="IHtmlLocalizer{TResource}"/> type.
		/// </summary>
		...
		/// <summary>
		/// Get a dynamic object that can be used to access localizble strings similar as <see cref="IStringLocalizer{T}"/> type.
		/// </summary>
		/// <typeparam name="T">The resource type.</typeparam>
		/// <returns>A dynamic object that can be used to access localizble strings.</returns>
		dynamic Text<T>();
